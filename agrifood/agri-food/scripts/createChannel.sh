...
createChannelGenesisBlock() {
	...
	set -x
	configtxgen -profile AgrifoodNetworkProfile -outputBlock ./channel-artifacts/${CHANNEL_NAME}.block -channelID $CHANNEL_NAME
	res=$?
	{ set +x; } 2>/dev/null
...
joinChannel "broker"
infoln "Joining factory peer to the channel..."
joinChannel "factory"
...
infoln "Setting anchor peer for factory..."
setAnchorPeer "factory"
